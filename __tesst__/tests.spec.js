...
describe("API call function", () => {
    test('API request', () => {
        ...
        const output = {polarity: "positive", subjectivity: "subjective", text: "learning front end development is very funny", polarity_confidence: 0.8428494334220886, subjectivity_confidence: 0.999999944248902
